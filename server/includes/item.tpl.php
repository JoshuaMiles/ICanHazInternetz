<?php
  echo('
    ...
    <div class="img-item">
      <img src="https://maps.googleapis.com/maps/api/streetview?maptype=satellite&pitch=-0.76&location=' . $hotspot['LATITUDE'] . ',' . $hotspot['LONGITUDE'] . '&zoom=18&size=800x250" alt="map of wifi hotspot">
