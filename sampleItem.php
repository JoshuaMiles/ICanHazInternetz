...
<nav id="fixed-nav">
    <div id="fixed-container">
        ...
        <ul>
            <li id="active"><a href="#" id="user"><i class="material-icons user-icon">person</i><strong> Login</strong></a>
            </li>
        ...
        <article>
            <div class="container">
                <div class="item-container">
                    ...
                    <div class="img-item">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14165.6641786731!2d153.00885146977544!3d-27.42514189999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b9159d688d2a2d7%3A0x83b7b25eb32b49eb!2sBrisbane+City+Council+-+Grange+Library!5e0!3m2!1sen!2sau!4v1462080935000"
                    ...
                    <article class="comments-section">
                        <h2 class="reviewTitle recommendedReviews"><span class="highlight">Recommend Reviews</span> for
                            Grange Public Library Wifi</h2>
                        <div class="comment-wrapper">
                            ...
                            <div class="cmt-box">
                                ...
                                <div class="cmt-body">
                                    ...
                                    <p class="cmt-text"><q>Had a coffee cart right outside the entrance, awesome
                                            find.</q></p>
                                    <span class="star-rating muted">4.5</span>
                                </div>
                            </div>
                        ...
                        <div class="cmt-wrapper">
                            <div class="cmt-box">
                                <div class="cmt-body">
                                    ...
                                    <textarea name="userComment" class="muted" id="userComment" rows="5"
                                              placeholder="Your rating helps others find better Wifi."></textarea>
                                    >>>>>>> 1708ab6f594b1c88acb3ff02816cf41ae80d0776:sampleItem.php
